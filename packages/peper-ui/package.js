...
Package.onUse(function(api) {
    ...
    api.mainModule('peper-client.js', 'client');
    api.addFiles([ 'client/css/materialdesignicons.css', 'client/css/peper.css', 'plugin/optiscroll/optiscroll.css'], 'client');
...
//   api.use('tinytest');
//   api.use('peper-ui');
//   api.mainModule('peper-ui-tests.js');
// });
