<template>
    <div class="peper-checkbox" @click="elOnClick()">
        ...
        <div ref="ripple" class="peper-checkbox-ripple"></div>
        <icon :name="uncheckIcon" class="peper-checkbox-uncheck"></icon>
        <icon :name="checkIcon" class="peper-checkbox-check"></icon>
    </div>
</template>
<script>
