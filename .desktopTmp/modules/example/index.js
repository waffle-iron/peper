...
var _module = require('./module.json');
...
class Example {
    constructor({ log, skeletonApp, appSettings, eventsBus, modules, settings, Module }) {
         ...
         */
        this.module = new Module(_module2.default.name);
    ...
    init() {
        ...
        this.eventsBus.emit(`${ _module2.default.name }.loaded`);
    }
...
exports.default = Example; /* eslint-disable no-unused-vars */